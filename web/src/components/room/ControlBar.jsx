        ...
        <div className="flex justify-center gap-10 flex-wrap">
          ...
          <div className="flex flex-col items-center">
            ...
            <button
              title="End Call"
              onClick={endCall}
              className="w-16 h-16 rounded-full bg-red-600 hover:bg-red-700 shadow-lg transition-all duration-300 hover:scale-110 text-white flex items-center justify-center"
            >
              <PhoneOff size={28} />
            </button>
